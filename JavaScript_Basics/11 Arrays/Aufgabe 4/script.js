...
Output YES if Ben can afford his rent with extra money, NO if he cannot afford his rent, and BARELY if he can afford his rent with no extra money
...
let p = parseInt(arrInput[0]);
let H = parseInt(arrInput[1]);
let R = parseInt(arrInput[2]);
